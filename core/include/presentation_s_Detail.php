...
<div class="col-12 editor">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"> Description de la rubrique <strong><?= str_replace("\'", "'", $rubrique) ?></strong></h5>
            <hr>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        Editer la description de<strong><?= str_replace("\'", "'", $rubrique)?></strong>
                    </h4>
...
<div class="col-12 editor_resume">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"> Resumé de la rubrique "<strong><?= str_replace("\'", "'", $rubrique)?></strong>"</h5>
            <hr>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        Editer résumé   <strong><?= str_replace("\'", "'", $rubrique) ?></strong>
                    </h4>
                    <!-- Create the editor container -->
                    <div class="form-group col-12"   style="width: 100%;height:200px">
...
<div class="card">
    <div class="card-body">
    <h5 class="card-title"> Pièces jointes  de la rubrique <strong><?= str_replace("\'", "'", $rubrique) ?></strong></h5>
    <hr>
        <!-- image -->
